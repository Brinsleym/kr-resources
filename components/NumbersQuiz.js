      ...
      <div className="w-full max-w-xl p-6 sm:p-8 bg-white rounded-2xl shadow-lg border border-gray-200">
        ...
        <div className="text-center">
          ...
          <input
            ...
            className="w-full text-center text-xl p-3 border-2 border-gray-300 rounded-lg mb-4 transition-all duration-200 focus:border-blue-600 focus:ring-2 focus:ring-blue-200 focus:outline-none"
            value={userAnswer}
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
            <button 
              onClick={checkAnswer} 
              disabled={feedback !== null} 
              className="w-full bg-blue-600 text-white font-bold py-3 px-4 rounded-lg hover:bg-blue-700 transition-colors duration-200 disabled:bg-gray-300 disabled:cursor-not-allowed"
            >
              Check Answer
            </button>
            <button 
              onClick={revealAnswer} 
              className="w-full bg-gray-500 text-white font-bold py-3 px-4 rounded-lg hover:bg-gray-600 transition-colors duration-200"
            >
            ...
            <div className="mt-6 p-4 bg-gray-50 rounded-lg min-h-[100px] flex items-center justify-center">
              <div className="text-left">
                <p className={`text-lg font-bold ${
                  ...
                  feedback === 'incorrect' ? 'text-red-600' : 'text-gray-800'
                }`}>
                  {feedback === 'correct' ? '정답! Correct!' : 
                   feedback === 'incorrect' ? '틀렸어요 Wrong!' : 'Korean pronunciation:'}
                </p>
          ...
          {feedback && !isRevealed && (
            <button 
              ...
              className="w-full mt-4 bg-gray-700 text-white font-bold py-3 px-4 rounded-lg hover:bg-gray-800 transition-colors duration-200"
            >
              Next Question
            </button>
          )}
